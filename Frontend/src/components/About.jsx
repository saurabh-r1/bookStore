        ...
        <section className="grid md:grid-cols-2 gap-8 items-center mb-12">
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-300 mb-6 max-w-xl">
              The Page Hub Bookstore curates practical books and short courses
              so learners focus on what matters — learning with clarity. Clean
              UI, friendly community, and resources you can trust.
            </p>
            ...
            <FeatureCard
              icon={
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M12 2L3 7v9c0 1.1.9 2 2 2h6v-9l1-1 1 1v9h6c1.1 0 2-.9 2-2V7l-9-5z" />
                </svg>
              }
              title="Curated books"
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow">
            <div className="flex items-center gap-6 md:gap-10 overflow-x-auto">
              <TimelineStep
                step="1"
                title="Discover"
                text="Search courses/books for your goal."
              />
              <div className="w-8 h-0 border-t border-dashed border-slate-200 dark:border-slate-700" />
              <TimelineStep
                step="2"
                title="Learn"
                text="Follow focused lessons & mini projects."
              />
              <div className="w-8 h-0 border-t border-dashed border-slate-200 dark:border-slate-700" />
              <TimelineStep
                step="3"
                title="Apply"
                text="Build and show your small projects."
              />
            </div>
          </div>
        </section>
          ...
          <div className="md:flex items-center justify-between">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-slate-100">
                Join thousands of learners exploring curated books & courses.
              </p>
            </div>
            ...
            <div className="flex gap-3">
              <a
                href="/course"
                className="px-4 py-2 rounded-md bg-white text-indigo-600 font-semibold"
              >
                Start learning
              </a>
              <a
